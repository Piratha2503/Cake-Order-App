...
function DeliverOptions() {
  return (
    <div className='deliver'>
      ...
      <p style={{paddingTop:'10%',marginLeft:'-45%' }}>Anywhere in Northern Province</p>  
      </Row>
      </div>
      <div className='deliver options'>
      <Row>
      ...
      <p style={{paddingTop:'10%',marginLeft:'-55%' }}>Anywhere in Northern Province</p>  
      </Row>
      </div>
      <div className='deliver options'>
      <Row>
      ...
      <p style={{paddingTop:'10%',marginLeft:'-52%' }}>Trusted under CBSL Policies</p>  
      </Row>
      </div>
      </Row>
    </div>
