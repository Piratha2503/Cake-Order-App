...
import PaymentOptions from './images/PaymentOptions.jpg'
...
function Myfooter() {
  return (
    <div style={{marginTop:'2%'}}>
     ...
     <Button type="link" className='policyLink' href='#'>Terms & Conditions</Button>
     <Button type="link" className='policyLink' href='#'>Privacy Policies</Button>
     <Button type="link" className='policyLink' href='#'>Return & Refund Orders</Button>
     </Col>
     </div>
     <div className='payments'>
     <h5 style={{marginLeft:'25%'}}>We Can Acept</h5>
     <img src={PaymentOptions} style={{height:'100px', width:'100%'}}></img>
     </div>
     <div className='contact'>
     <h3 style={{marginLeft:'10%',color:'black'}}>Follow Us </h3>
     <a><TwitterOutlined  style={{marginLeft:'7%'}}/></a>
     <a><InstagramOutlined  style={{marginLeft:'7%', color:'red'}} /></a> 
     <a><FacebookOutlined  style={{marginLeft:'7%'}}/></a>  
     </div>
     </Row>
     </div>
     <br/>
